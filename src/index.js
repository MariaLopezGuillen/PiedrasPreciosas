...
// Conectar a MongoDB
const dbURI = 'mongodb+srv://mariialg21:DBEosfN2oljsJ8TG@piedras.9kx1p.mongodb.net/piedras?retryWrites=true&w=majority';
...
// Otras rutas
app.get('/inicio', (req, res) => res.render('index', { title: 'Joyas Preciosas', gemas: [] }));
...
app.use((req, res) => {
  res.status(404).render('404', { titulo: "Error 404", descripcion: "Página no encontrada" });
});
